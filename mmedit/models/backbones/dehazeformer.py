...
def dehazeformer_t(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
		embed_dims=[24, 48, 96, 48, 24],
...
def dehazeformer_s(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
		embed_dims=[24, 48, 96, 48, 24],
...
def dehazeformer_b(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
        embed_dims=[24, 48, 96, 48, 24],
...
def dehazeformer_d(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
        embed_dims=[24, 48, 96, 48, 24],
...
def dehazeformer_w(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
...
def dehazeformer_m(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
		embed_dims=[24, 48, 96, 48, 24],
...
def dehazeformer_l(in_chans=3, out_chans=4):
    return DehazeFormer(
        in_chans=in_chans,
        out_chans=out_chans,
		embed_dims=[48, 96, 192, 96, 48],
...
if __name__ == "__main__":
    model = dehazeformer_t(320,64).cuda()
    x = torch.zeros((1,320,64,64)).cuda()
