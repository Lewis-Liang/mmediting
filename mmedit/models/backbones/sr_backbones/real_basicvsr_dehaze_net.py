...
from mmedit.models.backbones.sr_backbones.basicvsr_dehaze_net import (
    BasicVSRDehazeNet, ResidualBlocksWithInputConv)
from mmedit.models.registry import BACKBONES
from mmedit.utils import get_root_logger


@BACKBONES.register_module()
class RealBasicVSRDehazeNet(nn.Module):
