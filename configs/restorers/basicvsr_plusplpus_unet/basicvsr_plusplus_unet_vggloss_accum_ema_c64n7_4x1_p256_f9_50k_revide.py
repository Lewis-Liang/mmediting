exp_name = 'basicvsr_plusplus_unet_vggloss_accum_ema_c64n7_4x1_p256_f9_50k_revide'
...
custom_hooks = [
    ...
    dict(type='EvalIterHookFull', 
             config='configs/restorers/basicvsr_plusplpus_unet/basicvsr_plusplus_unet_vggloss_accum_ema_c64n7_4x1_p256_f9_50k_revide.py', 
             interval=2500, 
             save_image=True,
             priority='LOW'
    ) 
...
load_from = None
resume_from = 'work_dirs/basicvsr_plusplus_unet_vggloss_accum_ema_c64n7_4x1_p256_f9_50k_revide/latest.pth'
workflow = [('train', 1)]
