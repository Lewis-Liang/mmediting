# seed:1170519438
exp_name = 'basicdehazeformer_plusplus_1xvggloss_ssimloss_ema_accum8_c64n7_1x1_p256_f9_150k_revide'

# model settings
model = dict(
    type='BasicVSR_vggloss_ssimloss',
    generator=dict(
        type='BasicDehazeformerPlusPlus',
        dehazeformer_type='dehazeformer_t',
        mid_channels=64,
...
load_from = None
resume_from = 'work_dirs/basicdehazeformer_plusplus_1xvggloss_ssimloss_ema_accum8_c64n7_1x1_p256_f9_150k_revide/latest.pth'
workflow = [('train', 1)]
